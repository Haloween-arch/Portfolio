    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Availability Badge */}
          <div className="mb-4 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-medium">
            <Sparkles size={16} />
          ...
          <p className="mt-6 max-w-2xl text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            I design and build <strong>scalable web platforms</strong> and
            <strong> intelligent AI systems</strong> — from multi-agent
            architectures to production-ready full-stack applications that
